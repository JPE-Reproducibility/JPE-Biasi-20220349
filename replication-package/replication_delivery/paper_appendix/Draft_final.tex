...
4-94\% across districts in Wisconsin, 5-89\% in California, and 6-90\% in
...
Facing a projected budget deficit of \$3.6 billion  \citep{wisconsin_taxpayers_alliance_2011}, in February of 2011
...
members. As a result, membership in the state’s largest teachers’ union fell by more than 50\% between 2011 and 2015 \citep{baron2018effect}. Lastly, Act 10 reduced benefits for all public sector employees, except
...
\underline{w},\overline{w}\right]  ,$ such that\footnote{Empirically we set
$\underline{w}$ $\left(  \overline{w}\right)  $ to 0.3 standard deviations
...
0.8\% in 2010, 0.9\% in 2011, 0.9\% in 2012 and 1.0\% in 2013.} Our
