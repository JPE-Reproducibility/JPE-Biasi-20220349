...
contains
  ...
  subroutine utility_teacher(alpha, u)
    !double precision, dimension(nalpha) :: alpha
    !double precision, dimension(nteach, ndist) :: u
    double precision, dimension(nalpha), intent(in) :: alpha
  ...
  end subroutine utility_teacher_eqm

  
  !function utility_district(beta) result(u)
  subroutine utility_district(beta,u)
  ...
  end subroutine utility_district
