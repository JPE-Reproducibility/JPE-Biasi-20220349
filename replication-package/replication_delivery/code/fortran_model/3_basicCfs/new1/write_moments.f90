...
contains
  ...
  subroutine write_all_aux_params(aux_beta_model, aux_omega_model, aux_other_model)
    double precision, intent(in), dimension(naux,1)       :: aux_beta_model
    double precision, intent(in), dimension(naux_omega,1) :: aux_omega_model
    double precision, dimension(naux_other,1), intent(in) :: aux_other_model

    ! aux and omega aux
    call write_aux_param(aux_beta_model, aux_omega_model)
    ! 'other' aux
    call write_aux_other_param(aux_other_model)

  end subroutine write_all_aux_params


  ! writes both the aux and omega aux moments into the same txt file
  subroutine write_aux_param(aux_beta_model,aux_omega_model)
    double precision, intent(in), dimension(naux,1)       :: aux_beta_model
    double precision, intent(in), dimension(naux_omega,1) :: aux_omega_model
    ...
    write(1,f2) aux_beta(1,1),  aux_beta_model(1,1),  'wage            '
    write(1,f2) aux_beta(2,1),  aux_beta_model(2,1),  'exp(lambda)     '
    write(1,f2) aux_beta(3,1),  aux_beta_model(3,1),  'C1 * lambda     '
    write(1,f2) aux_beta(4,1),  aux_beta_model(4,1),  'inc             '
    write(1,f2) aux_beta(5,1),  aux_beta_model(5,1),  'inc * exp[1,3]  '
    write(1,f2) aux_beta(6,1),  aux_beta_model(6,1),  'inc * exp[4,5]  '
    write(1,f2) aux_beta(7,1),  aux_beta_model(7,1),  'inc * exp[6,10] '
    write(1,f2) aux_beta(8,1),  aux_beta_model(8,1),  'inc * exp[11,15]'
    write(1,f2) aux_beta(9,1),  aux_beta_model(9,1),  'samecz          '
    write(1,f2) aux_beta(10,1), aux_beta_model(10,1), 'urban           '
    write(1,f2) aux_beta(11,1), aux_beta_model(11,1), 'suburban        '
    write(1,f2) aux_beta(12,1), aux_beta_model(12,1), 'log(dist)       '
    write(1,f2) aux_beta(13,1), aux_beta_model(13,1), 'Milwaukee       '
    write(1,*) '"Big" match ols - offers from all districts'
    write(1,f1) 'Data', 'Model'
    write(1,f2) aux_beta(14,1), aux_beta_model(14,1), 'wage            '
    write(1,f2) aux_beta(15,1), aux_beta_model(15,1), 'exp(lambda)     '
    write(1,f2) aux_beta(16,1), aux_beta_model(16,1), 'C1 * lambda     '
    write(1,f2) aux_beta(17,1), aux_beta_model(17,1), 'inc             '
    write(1,f2) aux_beta(18,1), aux_beta_model(18,1), 'inc * exp[1,3]  '
    write(1,f2) aux_beta(19,1), aux_beta_model(19,1), 'inc * exp[4,5]  '
    write(1,f2) aux_beta(20,1), aux_beta_model(20,1), 'inc * exp[6,10] '
    write(1,f2) aux_beta(21,1), aux_beta_model(21,1), 'inc * exp[11,15]'
    write(1,f2) aux_beta(22,1), aux_beta_model(22,1), 'samecz          '
    write(1,f2) aux_beta(23,1), aux_beta_model(23,1), 'urban           '
    write(1,f2) aux_beta(24,1), aux_beta_model(24,1), 'suburban        '
    write(1,f2) aux_beta(25,1), aux_beta_model(25,1), 'log(dist)       '
    write(1,f2) aux_beta(26,1), aux_beta_model(26,1), 'Milwaukee       '
    write(1,*)
    write(1,f1) 'omega1 OLS                             '
    write(1,f1) 'Data', 'Model'
    write(1,f2) aux_omega(1,1),  aux_omega_model(1,1),  'Exp3          '
    write(1,f2) aux_omega(2,1),  aux_omega_model(2,1),  'Exp4          '
    write(1,f2) aux_omega(3,1),  aux_omega_model(3,1),  'Exp5          '
    write(1,f2) aux_omega(4,1),  aux_omega_model(4,1),  'Exp6          '
    write(1,f2) aux_omega(5,1),  aux_omega_model(5,1),  'master        '
    write(1,f2) aux_omega(6,1),  aux_omega_model(6,1),  'lambda        '
    write(1,f2) aux_omega(7,1),  aux_omega_model(7,1),  'tc            '
    write(1,f2) aux_omega(8,1),  aux_omega_model(8,1),  'tc_tenured    '
    write(1,f2) aux_omega(9,1),  aux_omega_model(9,1),  'budget_pc     '
    write(1,f2) aux_omega(10,1), aux_omega_model(10,1), 'capacity      '
    write(1,f2) aux_omega(11,1), aux_omega_model(11,1), 'urban         '
    write(1,f2) aux_omega(12,1), aux_omega_model(12,1), 'suburban      '
    write(1,f2) aux_omega(13,1), aux_omega_model(13,1), 'milwaukee     '
    write(1,f2) aux_omega(14,1), aux_omega_model(14,1), 'cz_tc         '
    write(1,f2) aux_omega(15,1), aux_omega_model(15,1), 'cz share ten  '
    write(1,f2) aux_omega(16,1), aux_omega_model(16,1), 'share dem vote'
    write(1,f2) aux_omega(17,1), aux_omega_model(17,1), 'intercept     '
    write(1,f1) 'omega2	OLS                              '
    write(1,f1) 'Data', 'Model'
    write(1,f2) aux_omega(18,1), aux_omega_model(18,1), 'Exp3          '
    write(1,f2) aux_omega(19,1), aux_omega_model(19,1), 'Exp4          '
    write(1,f2) aux_omega(20,1), aux_omega_model(20,1), 'Exp5          '
    write(1,f2) aux_omega(21,1), aux_omega_model(21,1), 'Exp6          '
    write(1,f2) aux_omega(22,1), aux_omega_model(22,1), 'master        '
    write(1,f2) aux_omega(23,1), aux_omega_model(23,1), 'lambda        '
    write(1,f2) aux_omega(24,1), aux_omega_model(24,1), 'tc            '
    write(1,f2) aux_omega(25,1), aux_omega_model(25,1), 'tc_tenured    '
    write(1,f2) aux_omega(26,1), aux_omega_model(26,1), 'budget_pc     '
    write(1,f2) aux_omega(27,1), aux_omega_model(27,1), 'capacity      '
    write(1,f2) aux_omega(28,1), aux_omega_model(28,1), 'urban         '
    write(1,f2) aux_omega(29,1), aux_omega_model(29,1), 'suburban      '
    write(1,f2) aux_omega(30,1), aux_omega_model(30,1), 'milwaukee     '
    write(1,f2) aux_omega(31,1), aux_omega_model(31,1), 'cz_tc         '
    write(1,f2) aux_omega(32,1), aux_omega_model(32,1), 'cz share ten  '
    write(1,f2) aux_omega(33,1), aux_omega_model(33,1), 'share dem vote'
    write(1,f2) aux_omega(34,1), aux_omega_model(34,1), 'intercept     '
    write(1,*) 'omega moments'
    write(1,f2) aux_omega(35,1), aux_omega_model(35,1), 'E(omega1)       '
    write(1,f2) aux_omega(36,1), aux_omega_model(36,1), 'E(omega2)       '
    write(1,f2) aux_omega(37,1), aux_omega_model(37,1), 'E(omega1*omega2)'
    write(1,f2) aux_omega(38,1), aux_omega_model(38,1), 'E(omega1^2)     '
    write(1,f2) aux_omega(39,1), aux_omega_model(39,1), 'E(omega2^2)     '
    write(1,*) 'omega fractions (probs)'
    do k=1,NWgrid1-1 ! 1 to 5
       write(1,f6) aux_omega(39+k,1), aux_omega_model(39+k,1), 'Pr_Omega1(',k,')    ' 
    enddo
    do k=1,NWgrid2-1 ! 1 to 7
       write(1,f6) aux_omega(44+k,1), aux_omega_model(44+k,1), 'Pr_Omega2(',k,')    '
    enddo
    write(1,*) 'omega old'
    write(1,f6) aux_omega(52,1), aux_omega_model(52,1),        'Pr_omega_Old    '
    write(1,*) 'omega x dem'
    write(1,f6) aux_omega(53,1), aux_omega_model(53,1),        'E(o1 x dem)     '
    write(1,f6) aux_omega(54,1), aux_omega_model(54,1),        'E(o2 x dem)     '
    write(1,f6) aux_omega(55,1), aux_omega_model(55,1),        'E(o1 | dem >=med'
    write(1,f6) aux_omega(56,1), aux_omega_model(56,1),        'E(o2 | dem >=med'
    write(1,*)
    ...
    write(1,f5) aux_beta(27,1), aux_beta_model(27,1), aux_beta(31,1), aux_beta_model(31,1), &
         aux_beta(35,1), aux_beta_model(35,1), aux_beta(39,1), aux_beta_model(39,1), 'Budget Left  '
    write(1,f5) aux_beta(28,1), aux_beta_model(28,1), aux_beta(32,1), aux_beta_model(32,1), &
         aux_beta(36,1), aux_beta_model(36,1), aux_beta(40,1), aux_beta_model(40,1), 'Capacity Left'
    write(1,f5) aux_beta(29,1), aux_beta_model(29,1), aux_beta(33,1), aux_beta_model(33,1), &
         aux_beta(37,1), aux_beta_model(37,1), aux_beta(41,1), aux_beta_model(41,1), 'Lambda       '
    write(1,f5) aux_beta(30,1), aux_beta_model(30,1), aux_beta(34,1), aux_beta_model(34,1), &
         aux_beta(38,1), aux_beta_model(38,1), aux_beta(42,1), aux_beta_model(42,1), 'Intercept    '

    write(1,*) 'Bottom 10% of Teachers'
    write(1,f5) aux_beta(43,1), aux_beta_model(43,1), aux_beta(47,1), aux_beta_model(47,1), &
         aux_beta(51,1), aux_beta_model(51,1), aux_beta(55,1), aux_beta_model(55,1), 'Budget Left  '
    write(1,f5) aux_beta(44,1), aux_beta_model(44,1), aux_beta(48,1), aux_beta_model(48,1), &
         aux_beta(52,1), aux_beta_model(52,1), aux_beta(56,1), aux_beta_model(56,1), 'Capacity Left'
    write(1,f5) aux_beta(45,1), aux_beta_model(45,1), aux_beta(49,1), aux_beta_model(49,1), &
         aux_beta(53,1), aux_beta_model(53,1), aux_beta(57,1), aux_beta_model(57,1), 'Lambda       '
    write(1,f5) aux_beta(46,1), aux_beta_model(46,1), aux_beta(50,1), aux_beta_model(50,1), &
         aux_beta(54,1), aux_beta_model(54,1), aux_beta(58,1), aux_beta_model(58,1), 'Intercept    '

    write(1,*) 'All Teachers'
    write(1,f5) aux_beta(59,1), aux_beta_model(59,1), aux_beta(63,1), aux_beta_model(63,1), &
         aux_beta(67,1), aux_beta_model(67,1), aux_beta(71,1), aux_beta_model(71,1), 'Budget Left  '
    write(1,f5) aux_beta(60,1), aux_beta_model(60,1), aux_beta(64,1), aux_beta_model(64,1), &
         aux_beta(68,1), aux_beta_model(68,1), aux_beta(72,1), aux_beta_model(72,1), 'Capacity Left'
    write(1,f5) aux_beta(61,1), aux_beta_model(61,1), aux_beta(65,1), aux_beta_model(65,1), &
         aux_beta(69,1), aux_beta_model(69,1), aux_beta(73,1), aux_beta_model(73,1), 'Lambda       '
    write(1,f5) aux_beta(62,1), aux_beta_model(62,1), aux_beta(66,1), aux_beta_model(66,1), &
         aux_beta(70,1), aux_beta_model(70,1), aux_beta(74,1), aux_beta_model(74,1), 'Intercept    '
  ...
  subroutine write_aux_other_param(aux_other_model)
    double precision, dimension(naux_other,1), intent(in) :: aux_other_model
    !moments
    ...
    !1
    mom1_model = reshape(aux_other_model(1:20,1), (/ 5,4 /))
    mom1       = reshape(aux_other(1:20,1),       (/ 5,4 /))
    !2
    mom2_model = reshape(aux_other_model(21:40,1), (/ 5,4 /))
    mom2       = reshape(aux_other(21:40,1)      , (/ 5,4 /))
    !3
    mom3_model = reshape(aux_other_model(41:48,1), (/ 2,4 /))
    mom3       = reshape(aux_other(41:48,1)      , (/ 2,4 /))
    !4
    mom4_model = reshape(aux_other_model(49:56,1), (/ 2,4 /))
    mom4       = reshape(aux_other(49:56,1)      , (/ 2,4 /))
    !5
    mom5_model = aux_other_model(57,1)
    mom5 = aux_other(57,1)
    !6
    mom6_model = aux_other_model(58:62,1)
    mom6       = aux_other(58:62,1)
    !7
    mom7_model = aux_other_model(63:67,1)
    mom7       = aux_other(63:67,1)       
    !8
    mom8_model = aux_other_model(68:69,1)
    mom8       = aux_other(68:69,1)      
    !9
    mom9_model = aux_other_model(70:71,1)
    mom9       = aux_other(70:71,1)
    !10
    mom10_model = aux_other_model(72:73,1)
    mom10       = aux_other(72:73,1)
    !11
    mom11_model = aux_other_model(74:78,1)
    mom11       = aux_other(74:78,1)
    !12
    mom12_model = reshape(aux_other_model(79:82,1), (/ 2,2 /))
    mom12       = reshape(aux_other(79:82,1)      , (/ 2,2 /))
    !13
    mom13_model = aux_other_model(83,1)
...
subroutine write_moment_weight_factors(aux_d, aux_omega_d, aux_other_d)
    double precision, intent(in), dimension(naux,1)       :: aux_d
    double precision, intent(in), dimension(naux_omega,1) :: aux_omega_d
    double precision, intent(in), dimension(naux_other,1)     :: aux_other_d
    ...
    k=1
    do i=1, naux
       write(55,f2) k, i, aux_d(i,1), aux_beta(i,1),weight_mat(i,i)/aux_weight_factor(i,1), &
    ...
    !omega aux moments
    do i=1, naux_omega
       write(55,f2) k, i, aux_omega_d(i,1), aux_omega(i,1), omega_weight_mat(i,i)/omega_weight_factor(i,1), &
    ...
    !'sim'/calib moments
    do i=1, naux_other
       write(55,f2) k, i, aux_other_d(i,1), aux_other(i,1), other_weight_mat(i,i)/other_weight_factor(i,1), &
