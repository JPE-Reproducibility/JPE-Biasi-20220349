...
!    to func
module simplex_salvador_equilibrium_w
  implicit none

contains
  recursive subroutine nelder_meade_eqm_wage(x,ftol,func,id,itmax,simplex_length,obj_tol,arg)
  ...
  end subroutine nelder_meade_eqm_wage
end module simplex_salvador_equilibrium_w
