...
**Summary:**
- Data files with PII indicators: 159
- Variables flagged in data: 263
- Code files with PII references: 650
- PII references in code: 24150
...
| Data | `Table_B22.csv` | 1 | district |
| Data | `Table_B25.csv` | 1 | district |
| Data | `WI_School_Districts.dbf` | 1 | district |
| Data | `WI_School_Districts.dta` | 3 | coord, district |
| Data | `cesa.dta` | 2 | district, name |
| Data | `crosswalk_census_state_id.csv` | 2 | district, name |
| Data | `crosswalk_district_county.dta` | 1 | district |
| Data | `cz_id.csv` | 1 | district |
| Data | `district_county_cz.dta` | 1 | district |
...
| Data | `temp.dta` | 5 | name, gender, birth, district |
| Data | `testscores.csv` | 2 | school, name |
